...
path_data=r'datasets\heart disease\processed.cleveland.data'
...
clf_fpipe_a= joblib.load(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_a.pkl')
...
#%% Saving the model
joblib.dump(clf_fpipe_a, r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_a.pkl', compress=1)
...
df_results_clf_fpipe_a.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\train_results_clf_fpipe_a.xlsx',index=True)
...
test_results_y_pred_clf_fpipe_a.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\test_results_y_pred_clf_fpipe_a.xlsx',index=False)
...
#%% Load the model saved to avoid a new fitting
clf_fpipe_b= joblib.load(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_b.pkl')
...
#%% Saving the model
joblib.dump(clf_fpipe_b, r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_b.pkl', compress=1)
...
# create an excel with the cross val resutls
df_results_clf_fpipe_b.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\train_results_clf_fpipe_b.xlsx',index=True)
...
test_results_y_pred_clf_fpipe_b.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\test_results_y_pred_clf_fpipe_b.xlsx',index=False)
...
#%% Load the model saved to avoid a new fitting
clf_fpipe_c= joblib.load(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_c.pkl')
...
# %%#%% Saving the model
joblib.dump(clf_fpipe_c, r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\clf_fpipe_c.pkl', compress=1)
...
# create an excel with the cross val resutls
df_results_clf_fpipe_c.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\train_results_clf_fpipe_c.xlsx',index=True)
...
test_results_y_pred_clf_fpipe_c.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\FeatureSelection_Classifier_Pipeline\GridSearchCV_results\HD_case\Cleveland\test_results_y_pred_clf_fpipe_c.xlsx',index=False)
